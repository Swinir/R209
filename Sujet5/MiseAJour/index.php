...
<html>
	<head>
		...
		<title>M2105 - Sujet 5 - Exo 3</title>
	</head>
    <!-- L'en-tête -->
    <header>
    ...
    <form method="POST" action="maj.php">
        <br>
        <label for="montant">Choisissez quel est la valeur que vous voulez mettre dans la base :</label>
        <input id="montant" name="montant" type="text" required autofocus/>
        <br>
        <p>Choisissez quel devise vous voulez modifier :</p>
